...
func (d *Daemon) ResetProxyPort(e *endpoint.Endpoint, isCTLocal bool, ips []net.IP, idsToMod policy.SecurityIdentityL4L7Map) {
...
// local or not (if it is not local then it is assumed to be global).
// Implementation of pkg/endpoint.Owner interface
func (d *Daemon) FlushCTEntries(e *endpoint.Endpoint, isCTLocal bool, ips []net.IP, idsToKeep policy.SecurityIdentityL4L7Map) {
