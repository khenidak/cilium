...
import (
	...
	k8sConst "github.com/cilium/cilium/pkg/k8s/apis/cnp.cilium.io"
...
var (
	...
	// FIXME FIXME FIXME these properties need a re-write!!!
	...
	PortRule = apiextensionsv1beta1.JSONSchemaProps{
		...
		Properties: map[string]apiextensionsv1beta1.JSONSchemaProps{
			"ports": {
				Description: "PortRules is a list of L4 port/protocol\n\nIf omitted or empty but " +
			...
			"redirectPort": {
				Description: "RedirectPort is the L4 port which, if set, all traffic matching " +
					"the PortRules is being redirected to. Whatever listener behind that port " +
